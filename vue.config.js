...
module.exports = {
    ...
    runtimeCompiler: true,// 设置为 true 后你就可以在 Vue 组件中使用 template 选项
     ...
     devServer: { // 所有 webpack-dev-server 的选项都支持
         ...
         proxy: {
            '/baidu_Token': {
                target: 'http://openapi.baidu.com', //请求本地 需要jeecg-boot后台项目
                ws: false,
                changeOrigin: true,//是否允许跨越
                pathRewrite: { 
                  '^/baidu_Token': 'http://openapi.baidu.com' //路径重写 
                  } 
              },
              '/baidu_Json': {
                target: 'http://vop.baidu.com', //请求本地 需要jeecg-boot后台项目
                ws: false,
                changeOrigin: true,//是否允许跨越
                pathRewrite: { 
                  '^/baidu_Json': 'http://vop.baidu.com' //路径重写 
                  } 
              }
         }, // 跨域代理
     },
